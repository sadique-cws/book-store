...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="h2 fw-bold">My Cart ({{ $count }})</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-8">
                ...
                @php
                    ...
                    $total_actual_amount += $item->product->price * $item->qty;
                    ...
                    $total_discount_amount = $total_actual_amount - $total_amount;
            ...
            <div class="col-4">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item list-group-item-action fw-bold">Total Amount <span class="float-end">₹{{$total_amount}}/-</span></li>
                ...
                <div class="row g-1 mt-4">
                    <div class="col-6">
                        <a href="" class="btn btn-warning w-100 btn-lg">More Shopping</a>
                    </div>
                    <div class="col-6">
